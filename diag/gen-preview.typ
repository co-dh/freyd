...
dpanel(5, 10.3, 7.45,
  ...
  ((4, [`⦇gen⦈`], black, 1.125, 1.7), (3, [`setify`], black, 0.55, 0.55), (2, [`union`], black, 0.55, 1.125), (1, [`est(R)`], black, 1.125)),
  ((1.125, [`L`]), (2.275, [`N`]), (7.45, [`Nat`])),
  ((2.85, [`L`]), (7.45, [`Nat`])),
  opath: ((7.45, 5), (4, 1), (4, 0))),

// ca3  ⦇gen⦈setify P(est(R))est(R)
dpanel(5, 10.3, 7.45,
  ((0.55, 3, 1, [`E`], none), (0.55, 4, 3, [`N`], none), (1.7, 4, 2, [`E`], none), (2.85, 4, "bot", none, none), (1.125, "top", 4, none, none), (2.275, "top", 4, none, none)),
  ((4, [`⦇gen⦈`], black, 1.125, 1.7), (3, [`setify`], black, 0.55, 0.55), (2, [`est(R)`], black, 1.7), (1, [`est(R)`], black, 0.55)),
  ((1.125, [`L`]), (2.275, [`N`]), (7.45, [`Nat`])),
  ((2.85, [`L`]), (7.45, [`Nat`])),
  opath: ((7.45, 5), (4, 2), (4, 0))),

// ca4  ⦇gen⦈N(est(R))setify est(R)
dpanel(5, 10.3, 7.45,
  ((0.55, 2, 1, [`E`], none), (0.55, 4, 2, [`N`], none), (1.7, 4, 3, [`E`], none), (2.85, 4, "bot", none, none), (1.125, "top", 4, none, none), (2.275, "top", 4, none, none)),
  ((4, [`⦇gen⦈`], black, 1.125, 1.7), (3, [`est(R)`], black, 1.7), (2, [`setify`], black, 0.55, 0.55), (1, [`est(R)`], black, 0.55)),
  ((1.125, [`L`]), (2.275, [`N`]), (7.45, [`Nat`])),
  ((2.85, [`L`]), (7.45, [`Nat`])),
