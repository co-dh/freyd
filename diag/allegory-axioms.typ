...
A cap at a product is two caps behind a crossing, so a pair unbends one strand at a time, and the
crossing is all that is left to move.

#chain(
  (l42iii.at(0).steps.at(1), l42iii.at(0).steps.at(2), l42iii.at(0).steps.at(4)),
  ([], [slide, twice], [`σ` past `S`]), s: 40%)
