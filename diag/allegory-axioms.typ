...
#let gr-RR = dpanel(3, 3.4, 0.55,
  (),
  ((2, [`R°`]), (1, [`R°`])),
  ((0.55, [`A`]),),
  ((0.55, [`A`]),),
  cert: (expect: "R° R°", src: "A", tgt: "A"), s: 100%)
#let gr-R = dpanel(2, 3.4, 0.55,
  (),
  ((1, [`R°`]),),
  ((0.55, [`A`]),),
  ((0.55, [`A`]),),
