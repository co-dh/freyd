...
// drawing is read back.  The note's own line is reported as a defect rather than edited.
//
//   typst compile --root . --format svg diag/cdref-sumlax.typ diag/cdref-sumlax.svg
//   ./scripts/diag-export --commutative Freyd.Alg.laxNatural_sum
