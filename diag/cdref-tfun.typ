...
// corners, same `length: 0.8cm`.  `Freyd.Alg.typeMap_fusion` states the triangle
// `T(f)⦇h⦈=⦇F(f,𝟙)h⦈`; the note draws that triangle with the fold's defining square beside it.
//
