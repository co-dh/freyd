...
// `F(f,𝟙)` through `F(A,TB)` — which is the fifth corner the note stands at.
//
...
#cetz.canvas(length: 0.8cm, {
  ...
  lab(0.4, 3.05, GIVEN2)[`α`]; lab(0.4, 0.6, GIVEN1)[`F(f,𝟙)α`]
  lab(-4.75, 1.25, INDUCED)[`F(𝟙,T(f))`]; lab(-4.25, -1.25, black)[`F(f,𝟙)`]
  lab(4.0, 1.25, INDUCED)[`T(f)`]; lab(0.7, -1.8, GIVEN1)[`α`]
