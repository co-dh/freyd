...
gen((1,2,3,4),({[5]},{[6]},{[7]},{[8]})) =
    ( {[1,5],[1,6],[1,8]},
      ...
      {[4,5],[4,7],[4,8]} )
```]
// lean:AOP.A7_4_Cylinder.gen@07f901a6 lean:AOP.A7_4_CylinderVec.gen_run@47a0e44e
]<cyl-gen>
...
#disp[#table(
  ...
  // lean:AOP.A7_4_Cylinder.cyl_cp@d2f022d7 lean:AOP.A4_6.Λ_eq_singleton_existsImage@02b29ea8
)]<cp-types>
...
```]
// lean:AOP.A7_4_Cylinder.Q@33f0d34e
]<q-step>
...
#disp[#calc-table(
  Thm[`Q=[N(wrap),(𝟙×moves trans N(est(R))) zip' N(cons)]` \
    #src[at the last column `Q` starts one path per row, and at each earlier one it puts each square in
     ...
     step folds]],
  // lean:AOP.A7_4_Cylinder.cyl_step@779f1f58
